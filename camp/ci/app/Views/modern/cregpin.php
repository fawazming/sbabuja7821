    ...
    <form id="reg-form" action="<?=base_url('registration')?>" method="post" class="fade hidden mt-6 space-y-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input type="email" id="email" required name="email" class="w-full border rounded-xl px-4 py-2 focus:ring-2 focus:ring-green-400 focus:border-green-400"/>
        </div>
        ...
        <div>
          ...
          <select id="category" name="category" required class="w-full border rounded-xl px-4 py-2 focus:ring-2 focus:ring-green-400 focus:border-green-400">
            <option value="">Select a Category</option>
            <option value="professionals">Professionals</option>
            <option value="graduate">Graduate</option>
            <option value="undergraduate">Undergraduate</option>
            <option value="school_leaver">School Leaver</option>
            <option value="secondary_school_student">Secondary school student</option>
          </select>
        </div>
      </div>
...
<script>
  ...
  const schLabel = document.getElementById("sch-label");
    ...
    let value = categoryEl.value; // initial value
